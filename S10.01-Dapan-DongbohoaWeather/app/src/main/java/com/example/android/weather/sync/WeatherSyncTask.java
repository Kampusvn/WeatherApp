...
//  Hoàn thành (1) Tạo lớp WeatherSyncTask
public class WeatherSyncTask {

//  Hoàn thành (2) Trong WeatherSyncTask, tạo ra một phương thức public static void đồng bộ tên là syncWeather
...
//      Hoàn thành (3) Trong syncWeather, tìm nạp dữ liệu thời tiết mới
...
//      		Hoàn thành (4) Nếu có kết quả hợp lệ, hãy xóa dữ liệu cũ và chèn dữ liệu mới

...
public final class WeatherUtils {
    ...
    /**
     * Dữ liệu nhiệt độ được lưu trữ theo giá trị Celsius. Tùy thuộc vào người dùng mà ứng dụng
     * có thể hiển thị dưới dạng Fahrenheit. Phương thức này sẽ thực hiện việc chuyển đổi nếu cần.
     * Nó cũng sẽ định dạng nhiệt độ để không hiển thị dưới dạng số thập phân. Nhiệt độ sẽ được
     * định dạng theo hình thức sau: "21 ° C"
     *
     */
    ...
    /**
     * Phương thức này trình bày dưới dạng: "HIGH°C / LOW°C"
     *
     */
    ...
    /**
     * Phương pháp này sử dụng hướng gió theo độ để xác định hướng la bàn như một chuỗi.
     * Ví dụ: NW) Phương pháp này sẽ trả lại chuỗi theo dạng sau: "2 km / h SW"
     *
     */
    ...
    /**
     * Phương thức trợ giúp để cung cấp chuỗi theo ID điều kiện thời tiết
     * được trả về bởi lời gọi OpenWeatherMap.
     */
    ...
    /**
     * Phương thức trợ giúp cung cấp ID icon theo ID điều kiện thời tiết
     * được trả về bởi lời gọi OpenWeatherMap.
     */
    public static int getIconResourceForWeatherCondition(int weatherId) {
        /*
         * Dựa trên http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
         */
        if (weatherId >= 200 && weatherId <= 232) {
    ...
    /**
     * Phương thức trợ giúp cung cấp ID của tài nguyên art theo ID điều kiện thời tiết
     * được trả về bởi lời gọi OpenWeatherMap.
     */

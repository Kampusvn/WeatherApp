...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    // TODO (3) Tạo biến final private ForecastAdapterOnClickHandler và đặt tên là mClickHandler

    // TODO (1) Thêm một interface là ForecastAdapterOnClickHandler
    // TODO (2) Trong interface này, định nghĩa một phương thức kiểu void lấy một String làm tham số

    // TODO (4) Thêm ForecastAdapterOnClickHandler làm tham số cho constructor và lưu trữ tại mClickHandler
    public ForecastAdapter() {

    }

    // TODO (5) Implement OnClickListener vào lớp ForecastAdapterViewHolder
    /**
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        public ForecastAdapterViewHolder(View view) {
            ...
            // TODO (7) Gọi setOnClickListener trong view chuyền vào constructor (dùng 'this' đại diện cho OnClickListener)
        }

        // TODO (6) Override onClick, truyền dữ liệu của ngày đã nhấp vào mclickHandler thông qua phương thức onClick
    }

...
//  Hoàn thành (1) Thêm phương thức bulkInsert
    /**
...
//          Hoàn thành (2) Chỉ thực hiện việc triển khai bulkInsert nếu URI phù hợp với mã CODE_WEATHER
            case CODE_WEATHER:
                db.beginTransaction();
                int rowsInserted = 0;
                try {
...
//              Hoàn thành (3) Trả lại số hàng được chèn từ thực hiện bulkInsert
                return rowsInserted;

//          Hoàn thành (4) Nếu URI phù hợp với CODE_WEATHER, hãy trả về super implementation của bulkInsert
            default:

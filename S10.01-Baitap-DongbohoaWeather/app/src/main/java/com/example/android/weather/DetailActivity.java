...
public class DetailActivity extends AppCompatActivity implements
    ...
    // Khai báo TextViews cho ngày, mô tả, nhiệt độ cao thấp, độ ẩm, gió và áp suất
...
//      Xóa mWeatherDisplay TextView
//      Tìm các TextView bằng ID
...
//      Xóa code kiểm tra extra text

//      Sử dụng getData để lấy tham chiếu đến URI được chuyền vào với intent của Activity
        mUri = getIntent().getData();
//      Ném ngoại lệ nếu URI is null
        if (mUri == null) throw new NullPointerException("URI for DetailActivity cannot be null");

//      Khởi tạo loader cho DetailActivity
...
//          Nếu loader được yêu cầu là detail loader, trả về CursorLoader thích hợp
...
//      Kiểm tra Cursor có dữ liệu hợp lệ không trước khi làm việc khác
        /*
...
//      Hiển thị mô tả (dùng WeatherUtils)
        /***********************
         * Weather Description *
         ***********************/
...
//  Override onLoaderReset, nhưng chưa làm gì ở đây
    /**

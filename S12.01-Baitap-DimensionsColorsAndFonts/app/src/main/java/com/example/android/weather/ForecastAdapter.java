...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    //  Khai báo hằng ID cho ViewType hôm nay và một ngày trong tương lai
    ...
    //  Khai báo biến private boolean tên là mUseTodayLayout
...
//      Đặt mUseTodayLayout thành giá trị trong resources
...
//      	Nếu view type của layout là hôm nay, dùng today layout
            case VIEW_TYPE_TODAY: {
                layoutId = R.layout.list_item_forecast_today;
                break;
            }

//			Nếu view type của layout là ngày trong tương lai, dùng future day layout
            case VIEW_TYPE_FUTURE_DAY: {
                layoutId = R.layout.forecast_list_item;
                break;
            }

//      Nếu không, ném ngoại lệ IllegalArgumentException
            default:
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        switch (viewType) {
//      	Nếu view type của layout là today, hiển thị icon lớn
            case VIEW_TYPE_TODAY:
                weatherImageId = WeatherUtils
                        .getLargeArtResourceIdForWeatherCondition(weatherId);
                break;

//      	Nếu view type của layout là ngày khác, hiển thị icon nhỏ
            case VIEW_TYPE_FUTURE_DAY:
                weatherImageId = WeatherUtils
...
//      Bên trong getItemViewType, nếu mUseTodayLayout là true và position là 0, trả về ID today viewType
        if (mUseTodayLayout && position == 0) {
            return VIEW_TYPE_TODAY;
//      Nếu không, trả về ID future day viewType
        } else {

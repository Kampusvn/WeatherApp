...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    //  Hoàn thành (2) Tăng phiên bản database sau khi thay đổi hành vi của bảng
    /*
...
//              Hoàn thành (1) Nối NOT NULL với khai báo kiểu của mỗi cột, ngoại trừ _ID
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // Hoàn thành (3) Trong phương thức onUpgrade, drop bảng weather nếu nó tồn tại
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + WeatherEntry.TABLE_NAME);
        // Hoàn thành (4) Gọi onCreate và chuyền vào SQLiteDatabase (chuyền vào onUpgrade)

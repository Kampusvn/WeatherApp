...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    //  Hoàn thành (6) Khai báo hằng ID cho ViewType hôm nay và một ngày trong tương lai
    ...
    //  Hoàn thành (7) Khai báo biến private boolean tên là mUseTodayLayout
...
//      Hoàn thành (8) Đặt mUseTodayLayout thành giá trị trong resources
...
//      	Hoàn thành (12) Nếu view type của layout là hôm nay, dùng today layout
            case VIEW_TYPE_TODAY: {
                layoutId = R.layout.list_item_forecast_today;
                break;
            }

//			Hoàn thành (13) Nếu view type của layout là ngày trong tương lai, dùng future day layout
            case VIEW_TYPE_FUTURE_DAY: {
                layoutId = R.layout.forecast_list_item;
                break;
            }

//      Hoàn thành (14) Nếu không, ném ngoại lệ IllegalArgumentException
            default:
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        switch (viewType) {
//      	Hoàn thành (15) Nếu view type của layout là today, hiển thị icon lớn
            case VIEW_TYPE_TODAY:
                weatherImageId = WeatherUtils
                        .getLargeArtResourceIdForWeatherCondition(weatherId);
                break;

//      	Hoàn thành (16) Nếu view type của layout là ngày khác, hiển thị icon nhỏ
            case VIEW_TYPE_FUTURE_DAY:
                weatherImageId = WeatherUtils
                        .getSmallArtResourceIdForWeatherCondition(weatherId);
                break;

//      	Hoàn thành (17) Nếu không, ném ngoại lệ IllegalArgumentException
            default:
                throw new IllegalArgumentException("Invalid view type, value of " + viewType);
        }
    ...
    //  Hoàn thành (9) Override getItemViewType
    @Override
    public int getItemViewType(int position) {
//      Hoàn thành (10) Bên trong getItemViewType, nếu mUseTodayLayout là true và position là 0, trả về ID today viewType
        if (mUseTodayLayout && position == 0) {
            return VIEW_TYPE_TODAY;
//      Hoàn thành (11) Nếu không, trả về ID future day viewType
        } else {

...
public final class WeatherPreferences {
    ...
    /**
     * Trả về giá trị true nếu người dùng muốn nhận thông báo từ ứng dụng, nếu không thì là false.
     * Tùy chọn này có thể được thay đổi bởi người dùng trong phần SettingsFragment.
     *
     * @param context dùng để truy cập SharedPreferences
     * @return true Trả về giá trị true nếu người dùng muốn nhận thông báo từ ứng dụng, nếu không thì là false.
     */
    public static boolean areNotificationsEnabled(Context context) {
        /* Khóa để truy cập vào tuỳ chọn hiển thị thông báo */
        String displayNotificationsKey = context.getString(R.string.pref_enable_notifications_key);

        /*
         * Trong Weather, người dùng có thể bật tắt nhận thông báo tùy ý. Nếu không có preference nào
		 * được chọn, ta sẽ xác định xem có hiển thị hay không. Để làm điều này, ta tham chiếu đến một
		 * bool được lưu trữ trong bools.xml.
         */
        boolean shouldDisplayNotificationsByDefault = context
                .getResources()
                .getBoolean(R.bool.show_notifications_by_default);

        /* Ta sẽ dùng SharedPreferences mặc định để truy vập vào preferences của người dùng */
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);

        /* Nếu có giá trị được lưu trữ trong key, ta sẽ xuất ra ở đây.Nếu không, sử dụng mặc định */

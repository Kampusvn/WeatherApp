    ...
    synchronized public static void syncWeather(Context context) {
        ...
        try {
            ...
            if (weatherValues != null && weatherValues.length != 0) {
                ...
                // Hoàn thành (13) Kiểm tra xem đã bật thông báo chưa
                ...
                // Hoàn thành (14) Kiểm tra thời gian từ thông báo cuối cùng đã được 1 ngày chưa
                if (timeSinceLastNotification >= DateUtils.DAY_IN_MILLIS) {
                    oneDayPassedSinceLastNotification = true;
                }

                // Hoàn thành (15) Nếu 2 điều kiện trên thỏa mãn thì thông báo cho người dùng

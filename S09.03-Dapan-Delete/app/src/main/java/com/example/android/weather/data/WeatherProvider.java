...
//  Hoàn thành (1) Triển khai phương thức xóa của ContentProvider
    /**
...
//          Hoàn thành (2) Chỉ thực hiện chức năng, cho URI thích hợp, để xóa tất cả các hàng trong bảng thời tiết
            case CODE_WEATHER:
...
//      Hoàn thành (3) Trả về số hàng bị xóa

...
public class MainActivity extends AppCompatActivity implements
        ...
        // Hoàn thành (3) Implement OnSharedPreferenceChangeListener ở MainActivity
    ...
    // Hoàn thành (4) Thêm cờ private static boolean cho các cập nhật preference và khởi tạo nó với giá trị false
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hoàn thành (6) Đăng ký MainActivity là một OnSharedPreferenceChangedListener ở onCreate
    ...
    private void openLocationInMap() {
        // Hoàn thành (9) Sử dụng vị trí ưa thích thay vì vị trí mặc định để hiển thị trên bản đồ
    ...
    // Hoàn thành (7) Trong onStart, nếu preferences bị thay đổi, refresh dữ liệu và đặt cờ là false
    @Override
    ...
    // Hoàn thành (8) Override phương thức onDestroy và hủy đăng ký MainActivity là SharedPreferenceChangedListener
    @Override
    ...
    // Hoàn thành (5) Override phương thức onSharedPreferenceChanged để đặt cờ preferences là true
    @Override

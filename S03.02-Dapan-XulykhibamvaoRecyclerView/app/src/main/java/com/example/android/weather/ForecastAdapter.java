...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    // Hoàn thành (3) Tạo biến final private ForecastAdapterOnClickHandler và đặt tên là mClickHandler
    /*
     * Trình xử lý giúp activity có thể giao tiếp với RecyclerView dễ dàng
     */
    private final ForecastAdapterOnClickHandler mClickHandler;

    // Hoàn thành (1) Thêm một interface là ForecastAdapterOnClickHandler
    // Hoàn thành (2) Trong interface này, định nghĩa một phương thức kiểu void lấy một String làm tham số
    /**
    ...
    // Hoàn thành (4) Thêm ForecastAdapterOnClickHandler làm tham số cho constructor và lưu trữ tại mClickHandler
    /**
     * Tạo ForecastAdapter.
     *
    ...
    // Hoàn thành (5) Implement OnClickListener vào lớp ForecastAdapterViewHolder
    /**
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        public ForecastAdapterViewHolder(View view) {
            ...
            // Hoàn thành (7) Gọi setOnClickListener trong view chuyền vào constructor (dùng 'this' đại diện cho OnClickListener)
            view.setOnClickListener(this);
        }

        // Hoàn thành (6) Override onClick, truyền dữ liệu của ngày đã nhấp vào mclickHandler thông qua phương thức onClick
        @Override

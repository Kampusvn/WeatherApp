...
// Hoàn thành (1) Implement giao diện LoaderCallbacks và các phương thức của giao diện này
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hoàn thành (7) Xóa code cho AsyncTask và khỏi tạo AsyncTaskLoader
        /*
    ...
    // Hoàn thành (2) Trong onCreateLoader, trả về AsyncTaskLoader mới cũng giống như FetchWeatherTask.
    /**
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle loaderArgs) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            // Hoàn thành (3) Cache dữ liệu thời tiết trong một biến thành viên và gửi nó trong onStartLoading.
            /**
    ...
    // Hoàn thành (4) Khi load xong, hiển thị dữ liệu về thời tiết hoặc báo lỗi nếu không có dữ liệu
    /**
    ...
    // Hoàn thành (6) Xóa tất cả code trong MainActivity có liên quan đến FetchWeatherTask
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Hoàn thành (5) Refactor chức năng refresh để làm việc với AsyncTaskLoader

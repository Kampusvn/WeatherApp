...
import static com.example.android.weather.data.TestUtilities.getConstantNameByStringValue;
...
/**
 * Used to test the database we use in Weather to cache weather data. Within these tests, we
 * test the following:
 * <p>
 * <p>
...
>>>>>>> 4174cf2... S07.02-Exercise-PreventInvalidInserts
     ...
     * <p>
     * {@link com.example.android.weather.data.WeatherContract.WeatherEntry#TABLE_NAME}.
     * <p>
     * Despite only needing to check one table name in Weather, we set this method up so that

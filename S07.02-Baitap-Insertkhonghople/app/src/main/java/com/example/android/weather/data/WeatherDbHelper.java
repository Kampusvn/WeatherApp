...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    //  TODO (2) Tăng phiên bản database sau khi thay đổi hành vi của bảng
    /*
...
//              TODO (1) Nối NOT NULL với khai báo kiểu của mỗi cột, ngoại trừ _ID
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // TODO (3) Trong phương thức onUpgrade, drop bảng weather nếu nó tồn tại
        // TODO (4) Gọi onCreate và chuyền vào SQLiteDatabase (chuyền vào onUpgrade)
    }
}